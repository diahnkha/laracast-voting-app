    ...
    <div class="idea-container rounded-xl flex  mt-4">
            ...
            <div class="flex flex-1 px-4 py-6">
                ...
                <div class="w-full mx-4">
                    ...
                    <div class="text-gray-600 mt-3 ">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci tenetur laborum inventore placeat debitis sequi iusto aliquam quos atque amet quas error eveniet voluptas, culpa perferendis eligendi dignissimos aut labore.
                    </div>
        ...
        <div class="buttons-container flex items-center justify-between mt-6">
            <div class="flex items-center space-x-4 ml-6">
                <button 
                    type="button"
                    class="flex items-center justify-center h-11 text-xs bg-blue
                    font-semibold rounded-xl border border-blue hover:bg-transition duration-150 ease-in
                ...
                <button 
                    type="button"
                    class="flex items-center justify-center w-36 h-11 w-36 text-xs bg-gray-200
