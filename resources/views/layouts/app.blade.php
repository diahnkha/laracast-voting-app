...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="https://fonts.bunny.net/css?family=Open+Sans:figtree:400,500,600&display=swap" rel="stylesheet" />
    ...
    <body class="font-sans text-gray-900 text-sm bg-gray-background">
        <header class="flex items-center flex-col md:flex-row justify-between px-8 py-4">
            <a href="#"><img src="{{ asset('img/logo.svg') }}" alt="logo"></a>
                ...
                @endif
                <a href="#">
                    <img src="https://www.gravatar.com/avatar/000000000000000000000000000000000000000000?d=mp" 
                    alt="avatar" class="w-10 h-10 rounded-full">
                </a>
            </div>
        </header>

        <main class="container mx-auto flex max-w-custom flex flex-col md:flex-row" >
            <div class="w-70 md:mr-5 mx-auto md:mx-0">
                <div class="mx-auto bg-white md:sticky md:top-8 border-2 border-blue rounded-xl mt-16"
                        style="
                    ...
                    <form action="#" method="POST" class="text-sm space-y-4 px-4 py-6">
                        ...
                        <div>
                            <textarea name="idea" id="idea" cols="30" rows="10" class="w-full bg-gray-100 rounded-xl placeholder-gray-900 text-sm px-4 py-2 border-none" placeholder="Describe Your Idea"></textarea>
                        </div>
            ...
            <div class="md:w-full px-2 md:px-0 md:w-175">
                <nav class="hidden md:flex items-center justify-between text-xs">
                    ...
                    <ul class="flex uppercase font-semibold border-b-4 pb-3 space-x-10">
                        <li><a href="#" class="text-gray-400 transition duration-150 ease-in border-b-4 pb-3 hover:border-blue">Implemented (0)</a></li>
