<x-app-layout>
    ...
    <div class="ideas-container space-y-6 my-6">
        <div class="idea-container hover:shadow-card bg-white rounded-xl flex transition duration-150 ease-in cursor-pointer">
            ...
            <div class="flex px-2 py-6">
                ...
                <div class="mx-4">
                    ...
                    <div class="text-gray-600 mt-3 line-clamp-3">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa explicabo voluptates, optio aliquid odit accusamus sed itaque quo sapiente in ullam distinctio blanditiis veritatis magnam quisquam illum atque alias similique quibusdam fugiat omnis architecto error aspernatur. Labore amet, aperiam natus fugit magni quibusdam itaque delectus nam fuga sit illo incidunt magnam doloremque consectetur veniam eius possimus error sunt omnis sapiente odio. Dolorem fugiat odit nemo! Ad provident illo delectus, quia in omnis asperiores nemo nostrum magni non commodi laudantium aperiam illum voluptate blanditiis cupiditate obcaecati hic excepturi, earum ipsam? Recusandae enim dolores nihil omnis magnam harum esse perferendis excepturi commodi.
                    </div>
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <button class="relative bg-gray-100 hover:bg-gray-200 rounded-full h-7 transition duration-150 ease-in px-3">
                                ...
                                <ul class="absolute w-64 font-semibold text-left bg-white shadow-dialog rounded-xl py-3 ml-8">
